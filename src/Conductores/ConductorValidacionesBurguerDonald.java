...
public class ConductorValidacionesBurguerDonald {
    public static void main (String[] args){
        ...
        //leerYValidarNuevoMenu
        System.out.println(funcion.leerYValidarNuevoMenu(2));

        //leerYValidarListaProductos
        System.out.println(funcion.leerYValidarListaProductos());
        ...
        System.out.println(funcion.leerYValidarDecremento(producto1));
    }
}
