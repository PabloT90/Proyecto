...
public class ConductorFuncionesProductos {
    public static void main (String[] args){
        ...
        //decrementarStock
        System.out.println(funcion.decrementarStock(producto1, 11));
        System.out.println(funcion.decrementarStock(producto1, 9));
        System.out.println(funcion.decrementarStock(producto1, 4));
